...
export default function NewMeeting() {
  ...
  let newMeetingFriends = [<div key='0' className="add-meeting-friends"><span>본인({myData.name})</span><span>위치를 설정해 주세요.</span><a href="/src/pages">위치 설정</a></div>];
  newMeetingFriends.push(<div key='1' className="add-meeting-friends"><span>정회운</span><span>위치를 설정해 주세요.</span><a href="/src/pages">위치 설정</a></div>)
